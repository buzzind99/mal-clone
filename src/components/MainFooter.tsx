          ...
          <div className={`${styles.bfr_app}`}>
            ...
            >
              <Image
                ...
                width={136}
                height={41}
                className="inline-block h-[1.875rem] w-[6.25rem] object-cover"
              />
            </a>
            <a
      ...
      >
        ...
        >
          <Image
            ...
            width={30}
            height={30}
            className="mx-3 inline-block h-5 w-5 object-cover"
          />
        ...
        >
          <Image
            ...
            width={52}
            height={60}
            className="mx-3 inline-block h-5 w-[1.0625rem] object-cover"
          />
        ...
        >
          <Image
            ...
            width={66}
            height={42}
            className="mx-3 inline-block h-4 w-[1.5625rem] object-cover"
          />
