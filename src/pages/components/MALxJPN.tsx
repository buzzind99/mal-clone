...
const MALxJPN = () => {
  return (
    <article
      id="mal-x-jpn"
      className="mx-[0.625rem] mb-[1.25rem] font-[Verdana] font-bold text-[0.75rem]"
    >
      <div
        id="mal-x-jpn_header"
        className="h-[1.375rem] py-[0.1875rem] border-b-[1px] border-[#bebebe] flex justify-between items-center"
      >
        <span className="float-left">MALxJapan -More than just anime-</span>
        <a
      ...
      <div id="mal-x-japan_content" className="flex justify-between mt-1">
        <a
