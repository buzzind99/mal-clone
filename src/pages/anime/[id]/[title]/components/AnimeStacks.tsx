...
const AnimeStacks: React.FC<Props> = ({ stacks, id, title }) => {
  ...
  return (
    <div id="interest-stacks" className="mb-5">
      ...
      >
        ...
        <span
          onClick={() =>
            openInNewTab(`https://myanimelist.net/anime/${id}/${title}/stacks`)
          }
      ...
      <div id="interest-stacks_content">
        {stacks &&
          stacks.map((stack, index) => (
            ...
            >
              <div className="relative inline-block h-[7.75rem] w-[6.875rem]">
                <Image
                  src={stack.image_2}
                  alt={stack.title}
                  width={85}
                  height={124}
                  className="z-2 absolute left-[1rem] top-0 h-[7.75rem] w-[85px] object-cover"
                ...
                <Image
                  ...
                  width={85}
                  height={124}
                  className="z-1 absolute left-0 top-0 h-[7.75rem] w-[85px] object-cover"
                  style={{ boxShadow: "2px 2px 5px 0 rgb(0 0 0 / 40%)" }}
                />
              </div>
